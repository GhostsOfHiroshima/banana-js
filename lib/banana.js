...
function indicatorBar(editor) {
    return atom.views.getView(editor).component.domNodeValue.querySelector('.indicator-bar');
}
...
export default {
  ...
  activate(state) {
    ...
    atom.workspace.observeTextEditors(editor => {
        /** TODO: editor 關掉時必須清除其資源 markerLayerInEditor, identifiersInEditor... */
        ...
        atom.views.getView(editor).component.domNodeValue.appendChild(indicatorBar);
